require('dotenv').config();            // Gerenciamento de variáveis de ambiente
require('express-async-errors');       // Captura erros em rotas async automaticamente
...
// Parsing de dados (usando Express nativo)
