...
exports.XdsClient = exports.Watcher = void 0;
...
var FileWatcherCertificateProvider = grpc_js_1.experimental.FileWatcherCertificateProvider;
...
function createCertificateProvider(config) {
...
class XdsClient {
    constructor(bootstrapInfoOverride) {
        ...
        this.certificateProviderRegistry = new Map();
        this.certificateProviderRegistryPopulated = false;
    ...
    getCertificateProvider(instanceName) {
