...
export declare const DOWNSTREAM_TLS_CONTEXT_TYPE_URL = "type.googleapis.com/envoy.extensions.transport_sockets.tls.v3.DownstreamTlsContext";
...
export declare const UPSTREAM_TLS_CONTEXT_TYPE_URL = "type.googleapis.com/envoy.extensions.transport_sockets.tls.v3.UpstreamTlsContext";
 ...
 */
export type AdsOutputType<T extends ResourceTypeUrl> = T extends EdsTypeUrl ? ClusterLoadAssignment__Output : T extends CdsTypeUrl ? Cluster__Output : T extends RdsTypeUrl ? RouteConfiguration__Output : T extends LdsTypeUrl ? Listener__Output : T extends HttpConnectionManagerTypeUrl ? HttpConnectionManager__Output : T extends ClusterConfigTypeUrl ? ClusterConfig__Output : T extends UpstreamTlsContextTypeUrl ? UpstreamTlsContext__Output : DownstreamTlsContext__Output;
export declare function decodeSingleResource<T extends ResourceTypeUrl>(targetTypeUrl: T, message: Buffer): AdsOutputType<T>;
