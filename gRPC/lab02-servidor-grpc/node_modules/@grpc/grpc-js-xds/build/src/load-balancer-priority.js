...
exports.PriorityLoadBalancer = void 0;
...
class PriorityLoadBalancer {
            ...
            startFailoverTimer() {
                if (this.failoverTimer === null) {
                    ...
                    this.failoverTimer = setTimeout(() => {
                        ...
                        this.updateState(grpc_js_1.connectivityState.TRANSIENT_FAILURE, new UnavailablePicker({ code: grpc_js_1.status.UNAVAILABLE, details: errorMessage }), errorMessage);
    ...
    selectPriority(priority, deactivateLowerPriorities) {
        ...
        this.updateState(chosenChild.getConnectivityState(), chosenChild.getPicker(), chosenChild.getErrorMessage());
    ...
    choosePriority() {
        ...
        for (const [priority, childName] of this.priorities.entries()) {
            ...
            if (child === undefined) {
                ...
                child.updateAddressList(childUpdate.subchannelAddress, childUpdate.lbConfig, this.latestOptions);
            }
            else {
    ...
    updateAddressList(endpointList, lbConfig, options) {
        ...
        for (const [childName, childConfig] of lbConfig.getChildren()) {
            ...
            if (existingChild !== undefined) {
                existingChild.updateAddressList(childAddresses, childConfig.config, options);
            }
        }
