...
export declare const _envoy_config_route_v3_RetryPolicy_ResetHeaderFormat: {
    readonly SECONDS: "SECONDS";
    readonly UNIX_TIMESTAMP: "UNIX_TIMESTAMP";
};
export type _envoy_config_route_v3_RetryPolicy_ResetHeaderFormat = 'SECONDS' | 0 | 'UNIX_TIMESTAMP' | 1;
