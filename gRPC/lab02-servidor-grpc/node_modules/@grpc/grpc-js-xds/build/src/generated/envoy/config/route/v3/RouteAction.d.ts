...
export declare const _envoy_config_route_v3_RouteAction_ClusterNotFoundResponseCode: {
    /**
 ...
 * @deprecated
 */
export declare const _envoy_config_route_v3_RouteAction_InternalRedirectAction: {
    readonly PASS_THROUGH_INTERNAL_REDIRECT: "PASS_THROUGH_INTERNAL_REDIRECT";
    readonly HANDLE_INTERNAL_REDIRECT: "HANDLE_INTERNAL_REDIRECT";
};
/**
 * Configures :ref:`internal redirect <arch_overview_internal_redirects>` behavior.
 * [#next-major-version: remove this definition - it's defined in the InternalRedirectPolicy message.]
 * @deprecated
 */
export type _envoy_config_route_v3_RouteAction_InternalRedirectAction = 'PASS_THROUGH_INTERNAL_REDIRECT' | 0 | 'HANDLE_INTERNAL_REDIRECT' | 1;
/**
 * Configures :ref:`internal redirect <arch_overview_internal_redirects>` behavior.
 * [#next-major-version: remove this definition - it's defined in the InternalRedirectPolicy message.]
 * @deprecated
