...
export declare const _envoy_config_cluster_v3_Cluster_ClusterProtocolSelection: {
    /**
     ...
     */
    readonly USE_CONFIGURED_PROTOCOL: "USE_CONFIGURED_PROTOCOL";
    /**
     * Use HTTP1.1 or HTTP2, depending on which one is used on the downstream connection.
     */
    readonly USE_DOWNSTREAM_PROTOCOL: "USE_DOWNSTREAM_PROTOCOL";
};
 ...
 */
export declare const _envoy_config_cluster_v3_Cluster_DiscoveryType: {
    /**
     ...
     * for an explanation.
     */
    readonly STRICT_DNS: "STRICT_DNS";
    /**
     * Refer to the :ref:`logical DNS discovery
     * type<arch_overview_service_discovery_types_logical_dns>`
     * for an explanation.
     */
    readonly LOGICAL_DNS: "LOGICAL_DNS";
    /**
     ...
     * for an explanation.
     */
    readonly ORIGINAL_DST: "ORIGINAL_DST";
};
/**
 * Refer to :ref:`service discovery type <arch_overview_service_discovery_types>`
 * for an explanation on each type.
 ...
 */
export declare const _envoy_config_cluster_v3_Cluster_DnsLookupFamily: {
    readonly AUTO: "AUTO";
    readonly V4_ONLY: "V4_ONLY";
    readonly V6_ONLY: "V6_ONLY";
    readonly V4_PREFERRED: "V4_PREFERRED";
    readonly ALL: "ALL";
};
/**
 * When V4_ONLY is selected, the DNS resolver will only perform a lookup for
 ...
 * [#next-major-version: deprecate AUTO in favor of a V6_PREFERRED option.]
 */
export type _envoy_config_cluster_v3_Cluster_DnsLookupFamily = 'AUTO' | 0 | 'V4_ONLY' | 1 | 'V6_ONLY' | 2 | 'V4_PREFERRED' | 3 | 'ALL' | 4;
/**
 * When V4_ONLY is selected, the DNS resolver will only perform a lookup for
 * addresses in the IPv4 family. If V6_ONLY is selected, the DNS resolver will
 * only perform a lookup for addresses in the IPv6 family. If AUTO is
 ...
 */
export declare const _envoy_config_cluster_v3_Cluster_RingHashLbConfig_HashFunction: {
    /**
     * Use `xxHash <https://github.com/Cyan4973/xxHash>`_, this is the default hash function.
     */
    readonly XX_HASH: "XX_HASH";
    /**
     * Use `MurmurHash2 <https://sites.google.com/site/murmurhash/>`_, this is compatible with
     * std:hash<string> in GNU libstdc++ 3.4.20 or above. This is typically the case when compiled
     * on Linux and not macOS.
     */
    readonly MURMUR_HASH_2: "MURMUR_HASH_2";
};
/**
 * The hash function used to hash hosts onto the ketama ring.
 */
 ...
 */
export declare const _envoy_config_cluster_v3_Cluster_LbPolicy: {
    /**
     ...
     * for an explanation.
     */
    readonly LEAST_REQUEST: "LEAST_REQUEST";
    /**
     * Refer to the :ref:`ring hash load balancing
     * policy<arch_overview_load_balancing_types_ring_hash>`
     * for an explanation.
     */
    readonly RING_HASH: "RING_HASH";
    /**
     ...
     * for an explanation.
     */
    readonly MAGLEV: "MAGLEV";
    /**
     * This load balancer type must be specified if the configured cluster provides a cluster
     * specific load balancer. Consult the configured cluster's documentation for whether to set
     * this option or not.
     */
    readonly CLUSTER_PROVIDED: "CLUSTER_PROVIDED";
    /**
     ...
     */
    readonly LOAD_BALANCING_POLICY_CONFIG: "LOAD_BALANCING_POLICY_CONFIG";
};
/**
 * Refer to :ref:`load balancer type <arch_overview_load_balancing_types>` architecture
 * overview section for information on each type.
 ...
 */
export declare const _envoy_config_cluster_v3_Cluster_LbSubsetConfig_LbSubsetFallbackPolicy: {
    readonly NO_FALLBACK: "NO_FALLBACK";
    readonly ANY_ENDPOINT: "ANY_ENDPOINT";
    readonly DEFAULT_SUBSET: "DEFAULT_SUBSET";
};
/**
 * If NO_FALLBACK is selected, a result
 * equivalent to no healthy hosts is reported. If ANY_ENDPOINT is selected,
 ...
 * endpoints matching the values from the default_subset field.
 */
export type _envoy_config_cluster_v3_Cluster_LbSubsetConfig_LbSubsetFallbackPolicy = 'NO_FALLBACK' | 0 | 'ANY_ENDPOINT' | 1 | 'DEFAULT_SUBSET' | 2;
/**
 * If NO_FALLBACK is selected, a result
 * equivalent to no healthy hosts is reported. If ANY_ENDPOINT is selected,
 * any cluster endpoint may be returned (subject to policy, health checks,
...
export declare const _envoy_config_cluster_v3_Cluster_LbSubsetConfig_LbSubsetMetadataFallbackPolicy: {
    /**
     * No fallback. Route metadata will be used as-is.
     */
    readonly METADATA_NO_FALLBACK: "METADATA_NO_FALLBACK";
    /**
     ...
     * is used.
     */
    readonly FALLBACK_LIST: "FALLBACK_LIST";
};
 ...
 */
export declare const _envoy_config_cluster_v3_Cluster_LbSubsetConfig_LbSubsetSelector_LbSubsetSelectorFallbackPolicy: {
    /**
     ...
     */
    readonly KEYS_SUBSET: "KEYS_SUBSET";
};
/**
 * Allows to override top level fallback policy per selector.
 */
