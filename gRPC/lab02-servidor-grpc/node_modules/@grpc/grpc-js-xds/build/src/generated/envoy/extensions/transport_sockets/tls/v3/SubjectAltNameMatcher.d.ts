 ...
 * against.
 */
export declare const _envoy_extensions_transport_sockets_tls_v3_SubjectAltNameMatcher_SanType: {
    readonly SAN_TYPE_UNSPECIFIED: "SAN_TYPE_UNSPECIFIED";
    readonly EMAIL: "EMAIL";
    readonly DNS: "DNS";
    readonly URI: "URI";
    readonly IP_ADDRESS: "IP_ADDRESS";
    readonly OTHER_NAME: "OTHER_NAME";
};
/**
 * Indicates the choice of GeneralName as defined in section 4.2.1.5 of RFC 5280 to match
 * against.
 */
export type _envoy_extensions_transport_sockets_tls_v3_SubjectAltNameMatcher_SanType = 'SAN_TYPE_UNSPECIFIED' | 0 | 'EMAIL' | 1 | 'DNS' | 2 | 'URI' | 3 | 'IP_ADDRESS' | 4 | 'OTHER_NAME' | 5;
/**
 * Indicates the choice of GeneralName as defined in section 4.2.1.5 of RFC 5280 to match
 * against.
 */
