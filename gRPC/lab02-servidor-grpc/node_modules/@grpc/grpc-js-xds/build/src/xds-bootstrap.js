...
var parseDuration = grpc_js_1.experimental.parseDuration;
var durationToMs = grpc_js_1.experimental.durationToMs;
...
function validateFileWatcherPluginConfig(obj, instanceName) {
...
const pluginConfigValidators = {
    'file_watcher': validateFileWatcherPluginConfig
};
function validateCertificateProvider(obj, instanceName) {
...
function validateCertificateProvidersMap(obj) {
    if (!obj) {
        return {};
    }
    const result = {};
